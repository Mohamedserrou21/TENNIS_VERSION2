...
namespace TENNIS_APP.Migrations
{
    ...
    [Migration("20220507142914_correct2")]
    partial class correct2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TENNIS_APP.Models.Video", b =>
                {
                    b.Property<int?>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.Property<string>("Joueur_video")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                    ...
                    b.Property<string>("Source")
                        .IsRequired()
                        .HasColumnName("Video_Player")
                        .HasColumnType("nvarchar(max)")
                        .HasMaxLength(1000000);

                    b.Property<int?>("Video_Joueur")
                        .HasColumnType("int");

                    b.HasKey("id");

                    b.HasIndex("Video_Joueur");
            ...
            modelBuilder.Entity("TENNIS_APP.Models.Video", b =>
                {
                    b.HasOne("TENNIS_APP.Models.Joueur", "Video_JO")
                        .WithMany()
                        .HasForeignKey("Video_Joueur");
                });
